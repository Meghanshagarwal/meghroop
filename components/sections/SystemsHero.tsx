    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden grid-bg pt-24 sm:pt-28 md:pt-32" aria-label="Systems Showcase Intro">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 text-center flex flex-col items-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2.5 px-3.5 py-2 rounded-full glass text-xs text-gray-400 mb-6 font-mono border border-white/[0.06] hover:border-white/10 transition-colors"
        >
        ...
        <motion.p
          ...
          className="text-gray-400 text-base sm:text-lg md:text-xl max-w-3xl leading-relaxed mb-12"
        >
        ...
        <motion.div
          ...
          className="w-full max-w-4xl rounded-2xl border border-white/[0.08] bg-[#050505]/80 p-6 sm:p-8 backdrop-blur-md relative overflow-hidden group hover:border-white/[0.12] transition-colors duration-300"
        >
