...
export default function WordPressCTA() {
  return (
    <section
      id="contact"
      aria-label="Call to action to start a WordPress engineering project"
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          Publishing systems{' '}
          <br />
          <span className="gradient-text">that scale quietly.</span>
        </motion.h2>
        ...
        >
          Sometimes good engineering feels invisible. Your content loads instantly. Your team publishes without friction. Your site ranks well. Performance never gets mentioned because it&apos;s so obvious. That&apos;s what we build.
        </motion.p>
        ...
        <motion.div {...fadeUp(0.35)} className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <Link
            href="#faq"
            onClick={() => trackEvent('cta_click', 'ViewContent', { label: 'learn_more_faq_cta', location: 'cta' })}
          ...
          <a
            href="mailto:hello@meghroop.tech?subject=WordPress%20Engineering%20Project"
            onClick={() => trackEvent('cta_click', 'Contact', { label: 'email_hello_wordpress', location: 'cta' })}
