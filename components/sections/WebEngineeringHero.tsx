...
const pills = ['Custom Websites', 'Next.js Development', 'React Applications', 'UI Engineering', 'Performance Optimization', 'Interactive Experiences']

export default function WebEngineeringHero() {
  return (
    <section
      id="web-engineering-hero"
      aria-label="Web Engineering and Modern Website Development"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.div {...fadeUp(0)} className="flex justify-center mb-6 sm:mb-8">
          <div className="inline-flex flex-wrap justify-center items-center gap-x-2 gap-y-1 px-3 sm:px-4 py-2 rounded-full glass text-xs sm:text-sm text-gray-300">
            ...
            <span>Modern Web Engineering & UI Systems</span>
            <span className="hidden sm:inline-flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
              <span className="text-emerald-400 text-xs">Building beautiful</span>
            </span>
          </div>
        </motion.div>
        ...
        >
          ...
          <br />
          <span className="gradient-text">actually feel alive.</span>
          <br />
          Fast. Beautiful. Intentional.
        </motion.h1>
        ...
        <motion.div {...fadeUp(0.5)} className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <Link
            href="#what-we-build"
            onClick={() => trackEvent('cta_click', 'ViewContent', { label: 'explore_web_engineering', location: 'hero' })}
          ...
          <Link
            href="#contact"
            onClick={() => trackEvent('cta_click', 'Contact', { label: 'build_website', location: 'hero' })}
        ...
        >
          {[
            { value: '25+', label: 'Web Projects Live' },
