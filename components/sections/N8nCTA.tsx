  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <Link href="/agentic-ai" className="hover:text-blue-400 transition-colors">AI Agents & Automation</Link>
          <span className="text-white/10">•</span>
          <Link href="/agentic-ai" className="hover:text-blue-400 transition-colors">MCP Infrastructure</Link>
          <span className="text-white/10">•</span>
          <Link href="/agentic-ai" className="hover:text-blue-400 transition-colors">n8n Workflows</Link>
          <span className="text-white/10">•</span>
          <Link href="/growth-marketing" className="hover:text-blue-400 transition-colors">AI Search (GEO)</Link>
          <span className="text-white/10">•</span>
          <Link href="/shopify-development" className="hover:text-blue-400 transition-colors">Shopify Development</Link>
          <span className="text-white/10">•</span>
          <Link href="/software-development" className="hover:text-blue-400 transition-colors">Next.js Web Engineering</Link>
          <span className="text-white/10">•</span>
          <Link href="/wordpress-development" className="hover:text-blue-400 transition-colors">WordPress Engineering</Link>
        </motion.div>
      </div>
    </section>
  )
