...
const pills = ['n8n Workflows', 'AI Automation', 'API Integration', 'CRM Workflows', 'Lead Automation', 'Operational Systems']

export default function N8nWorkflowsHero() {
  return (
    <section
      id="n8n-workflows-hero"
      aria-label="n8n Workflow Automation and Operational Systems"
      className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg pt-16"
    >
      {/* Floating gradient orbs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-600/25 rounded-full blur-[120px] animate-float" />
        <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-cyan-600/20 rounded-full blur-[120px] animate-float-delay" />
        ...
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-blue-600/10 rounded-full blur-[100px] animate-float" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.div {...fadeUp(0)} className="flex justify-center mb-6 sm:mb-8">
          <div className="inline-flex flex-wrap justify-center items-center gap-x-2 gap-y-1 px-3 sm:px-4 py-2 rounded-full glass text-xs sm:text-sm text-gray-300">
            ...
            <span>Workflow Automation & Operational Infrastructure</span>
            <span className="hidden sm:inline-flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
              <span className="text-emerald-400 text-xs">Always working</span>
            </span>
          </div>
        </motion.div>
        ...
        >
          Automation systems that quietly scale your operations.{' '}
          <span className="text-white">n8n workflows that eliminate repetition, connect your tools, and engineer operational infrastructure that actually works.</span> Not scattered automations. Not automation chaos. Well-designed systems that remove work from your team.
        </motion.p>
        ...
        <motion.div {...fadeUp(0.5)} className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
          <Link
            ...
            onClick={() => trackEvent('cta_click', 'ViewContent', { label: 'explore_n8n_workflows', location: 'hero' })}
