...
const services = [
  {
    ...
    gradient: 'from-cyan-600/[0.12] to-blue-600/[0.12]',
  },
  {
    ...
    gradient: 'from-emerald-600/[0.12] to-teal-600/[0.12]',
  },
  {
    id: 'ai-voice-agents',
    icon: HeadphonesIcon,
    ...
    gradient: 'from-blue-600/[0.12] to-violet-600/[0.12]',
  },
  {
    id: 'custom-ai-agents',
    icon: Bot,
    ...
    gradient: 'from-violet-600/[0.12] to-purple-600/[0.12]',
  },
  {
    id: 'ai-integration',
    icon: Plug,
    ...
    gradient: 'from-pink-600/[0.12] to-rose-600/[0.12]',
  },
  {
    ...
    gradient: 'from-amber-600/[0.12] to-orange-600/[0.12]',
  },
  {
    id: 'sales-ai',
    icon: TrendingUp,
    ...
    gradient: 'from-sky-600/[0.12] to-cyan-600/[0.12]',
  },
]
...
export default function ServicesPageGrid() {
  return (
    <section id="our-services" className="section-padding" aria-label="Our AI services">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          {services.map((service) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative rounded-2xl border border-white/[0.08] ${service.borderHover} overflow-hidden transition-all duration-300 scroll-mt-28`}
              >
                <div className="absolute inset-0 bg-[#0a0a0a]" />
                <div className={`absolute inset-0 bg-gradient-to-br ${service.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`} />
                <div className="relative z-10 p-7 sm:p-8 h-full flex flex-col">
                  <div className="w-11 h-11 rounded-xl bg-white/[0.06] border border-white/[0.06] flex items-center justify-center mb-5 group-hover:bg-white/[0.1] transition-colors duration-300">
        ...
        <p className="sr-only">
          MeghRoop provides end-to-end AI services including AI strategy and readiness audits, agentic systems and
          process automation, AI voice agents, custom AI agent development, AI integration with existing CRM and ERP
