  ...
  return (
    <section id="contact" className="section-padding overflow-hidden" aria-label="Call to action for Shopify development">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        >
          <Link href="/agentic-ai" className="hover:text-emerald-400 transition-colors">AI Agents & Automation</Link>
          <span className="text-white/10">•</span>
          <Link href="/agentic-ai" className="hover:text-emerald-400 transition-colors">MCP Infrastructure</Link>
          <span className="text-white/10">•</span>
          <Link href="/agentic-ai" className="hover:text-emerald-400 transition-colors">n8n Workflows</Link>
          <span className="text-white/10">•</span>
          <Link href="/growth-marketing" className="hover:text-emerald-400 transition-colors">AI Search (GEO)</Link>
          <span className="text-white/10">•</span>
          <Link href="/shopify-development" className="hover:text-emerald-400 transition-colors">Shopify Development</Link>
          <span className="text-white/10">•</span>
          <Link href="/software-development" className="hover:text-emerald-400 transition-colors">Next.js Web Engineering</Link>
          <span className="text-white/10">•</span>
          <Link href="/wordpress-development" className="hover:text-emerald-400 transition-colors">WordPress Engineering</Link>
        </motion.div>
      </div>
    </section>
  )
