  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        .usecases-section {
        .usecases-section h2 {
        .usecases-section > .container > p {
        .usecases-grid {
        .usecase-card {
        .usecase-card:hover {
        .usecase-icon {
        .usecase-card:nth-child(1) .usecase-icon {
        .usecase-card:nth-child(2) .usecase-icon {
        .usecase-card:nth-child(3) .usecase-icon {
        .usecase-card:nth-child(4) .usecase-icon {
        .usecase-card h3 {
        .usecase-card p {
        .stack-section {
        .stack-section h2 {
        .stack-section > .container > p {
        .stack-categories {
        ...
        .safety-section {
        .safety-section h2 {
        .safety-section > .container > p.section-desc {
        .safety-wrapper {
        ...
        .footer-socials a:hover {
            ...
            .safety-wrapper { padding: 32px 24px; }
            .cta-wrapper {
