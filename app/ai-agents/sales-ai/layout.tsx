  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Service","name":"Sales Intelligence & Outreach Automation","description":"Signal-triggered, AI-researched cold outreach that fills your pipeline with qualified meetings. No spray-and-pray.","provider":{"@type":"Organization","name":"MeghRoop","url":"https://meghroop.tech","email":"hello@meghroop.tech","telephone":"+918949508264","foundingDate":"2022","address":{"@type":"PostalAddress","streetAddress":"Jhotwara","addressLocality":"Jaipur","addressRegion":"Rajasthan","postalCode":"302012","addressCountry":"IN"}},"areaServed":{"@type":"Place","name":"Worldwide"},"serviceType":"Sales Intelligence & Outreach Automation","hasOfferCatalog":{"@type":"OfferCatalog","name":"Sales AI Services","itemListElement":[{"@type":"Offer","itemOffered":{"@type":"Service","name":"Signal-Triggered Outbound"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"Multi-Channel Outreach"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"AI-Powered Sales Intelligence"}}]}}) }}
      />
      {children}
    </>
  )
