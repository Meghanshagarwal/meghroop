  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"Service","name":"AI Integration Services","description":"We integrate AI into your existing CRM, ERP, helpdesk, and collaboration tools. MCP servers, API connections, and intelligent automation — without replacing your stack.","provider":{"@type":"Organization","name":"MeghRoop","url":"https://meghroop.tech","email":"hello@meghroop.tech","telephone":"+918949508264","address":{"@type":"PostalAddress","addressLocality":"Jaipur","addressRegion":"Rajasthan","addressCountry":"IN"},"foundingDate":"2022"},"serviceType":"AI Integration & Automation","areaServed":"Worldwide","hasOfferCatalog":{"@type":"OfferCatalog","name":"AI Integration Services","itemListElement":[{"@type":"Offer","itemOffered":{"@type":"Service","name":"CRM AI Integration"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"ERP AI Integration"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"MCP Server Development"}},{"@type":"Offer","itemOffered":{"@type":"Service","name":"Legacy System AI Bridge"}}]}}) }}
      />
      {children}
    </>
  )
