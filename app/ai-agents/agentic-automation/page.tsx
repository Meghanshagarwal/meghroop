  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        .stack-pill:hover {
        .stack-pill-dot {
        .stack-pill-dot.purple { background: #a855f7; }
        .stack-pill-dot.blue { background: #3b82f6; }
        .stack-pill-dot.cyan { background: #06b6d4; }
        .stack-pill-dot.emerald { background: #10b981; }
        .stack-pill-dot.amber { background: #f59e0b; }
        .stack-pill-dot.rose { background: #f43f5e; }
        .faq-section {
        .faq-list {
        .faq-item {
        .faq-question {
