        ...
        <section className="border-t border-white/[0.06]">
          <div className="max-w-7xl mx-auto px-6 py-20 sm:py-24 grid grid-cols-1 md:grid-cols-2 gap-px bg-white/[0.06] border border-white/[0.06] rounded-2xl overflow-hidden">
            {[
              ...
              {
                label: 'Web & WordPress Hosting',
                href: '/wordpress-hosting',
                dot: 'bg-[#60a5fa]',
                sub: 'Fully managed web, WordPress & VPS hosting from ₹49/mo — 4 plans, 20% off yearly, free SSL & migration, with a 30-day money-back guarantee.',
              },
            ].map((s) => {
